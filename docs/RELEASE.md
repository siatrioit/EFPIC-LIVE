...
| RAW + ★ XMP (LibRaw bāze) | `image_edit_service.dart` `resolveXmpSourcePath`, `applyAndSaveWithXmp` |
| RAW mozaīkas eksports (Z8) | `TiledLibRawDevelopEngine.kt`, `LibRawSupport.demosaicCropToLinear` |
